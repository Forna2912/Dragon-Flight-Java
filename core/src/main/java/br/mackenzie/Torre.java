...
public class Torre extends GameObject {
    ...
    public Torre(Texture texture, float x, float y, float width, float height, Viewport viewport) {
        super(texture, x, y, width, height);
        texturetorre2 = new Texture("torre.png");
        this.torre2 = new Torre2(texturetorre2, x, y+height+1.5f, width, height, viewport);
